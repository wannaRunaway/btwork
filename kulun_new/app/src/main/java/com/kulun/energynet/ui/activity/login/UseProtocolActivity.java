...
public class UseProtocolActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.header.title.setText("库仑能网用户服务协议");
        ...
        String message =  "特别提示\n" +
                "1.1  本《库仑能网用户服务协议》（以下简称《协议》）是服务使用人（以下简称“用户”）与库仑能网科技发展有限公司（以下简称“库仑”）之间关于用户下载、安装、使用“库仑能网”软件，注册、使用、管理“库仑能网”帐号，以及使用库仑提供的相关服务所订立的协议。\n" +
                ...
                "账户注册\n" +
                "2.1  用户在使用本服务前需要注册一个“库仑能网”帐号。“库仑能网”帐号应当使用手机号码绑定注册，请用户使用尚未与“库仑能网”帐号绑定的手机号码，以及未被库仑根据本协议封禁的手机号码注册“库仑能网”帐号。库仑可以根据用户需求或产品需要对帐号注册和绑定的方式进行变更，而无须事先通知用户。\n" +
                "2.2  “库仑能网”系基于地理位置的新能源汽车换电产品，用户注册时应当授权库仑使用其地理位置信息方可成功注册“库仑能网”帐号。故用户完成注册即表明用户同意库仑提取及使用用户的地理位置信息。\n" +
                "服务内容\n" +
                "3.1   “库仑能网”服务的具体内容由库仑根据实际情况提供，主要包括用户的注册登录、换电站导航、预约换电、到站扫码换电、评价、查询记录等。其中到站扫码换电费用，按照司机默认车辆车型计算，司机扫码前需确认默认车辆信息。库仑可以对其提供的服务予以变更，且库仑提供的服务内容可能随时变更；用户将会收到库仑关于服务变更的通知。\n" +
                ...
                "个人信息：例如手机号、真实姓名、身份证号等信息。\n" +
                "支付：用户在“库仑能网”上支付时，可以选择第三方支付机构（如微信支付、支付宝）所提供的支付服务。支付功能本身并不收集您的个人信息，但我们需要将用户的订单信息及对账信息与这些支付机构共享以确认用户的支付指令并完成支付。\n" +
                "客服：当用户与客服取得联系时，系统可能会记录用户与客服之间的通讯记录，以及使用用户的账号信息以便核验身份；当用户需要客服协助修改有关信息时，可能还需要提供上述信息外的其他信息以便完成修改。\n" +
                "位置信息：为了便捷用户发现周边的换电站和预约时推荐换电站，库仑会基于用户的地理位置提供服务（LBS）。当用户开启设备定位功能并使用LBS时，库仑可能会收集和使用用户的位置信息，以实现用户查询周边换电站和预约的目的。\n" +
                "设备信息：系统可能会根据用户在软件安装及使用中的具体权限，接收并记录用户在接受服务过程中使用的相关设备信息，例如设备型号、唯一设备标识符、操作系统、分辨率、电信运营商等软硬件信息等。\n" +
                "4.3  库仑未经用户同意不得向任何第三方公开、透露用户个人隐私信息。但以下特定情形除外：\n" +
                "库仑根据法律法规规定或有权机关的指示提供用户的个人隐私信息；\n" +
                "由于用户将其账户密码告知他人或与他人共享注册帐户与密码，由此导致的任何个人信息的泄漏，或其他非因库仑原因导致的个人隐私信息的泄露；\n" +
                "用户自行向第三方公开其个人隐私信息；\n" +
                "用户与库仑及合作单位之间就用户个人隐私信息的使用公开达成约定，库仑因此向合作单位公开用户个人隐私信息；\n" +
                "任何由于黑客攻击、电脑病毒侵入及其他不可抗力事件导致用户个人隐私信息的泄露；\n" +
                "用户个人信息已经经过处理无法识别特定个人且不能复原。\n" +
                "4.4  用户同意库仑可在以下事项中使用用户的个人隐私信息：\n" +
                "库仑向用户及时发送重要通知，如软件更新、本协议条款的变更；\n" +
                "库仑内部进行审计、数据分析和研究等，以改进库仑的产品、服务和与用户之间的沟通；\n" +
                "依本协议约定，库仑管理、审查用户信息及进行处理措施；\n" +
                "适用法律法规规定的其他事项。\n" +
                "使用规则\n" +
                "5.1  用户在申请使用“库仑能网”服务时，必须向库仑提供准确、真实的个人相关资料，且需要通过库仑的认证后方能开始使用软件。如个人资料有任何变动，必须及时更新。更新过程中，库仑有权暂停该用户的使用权，经过库仑对更新信息的再次认证后方能继续使用软件。\n" +
                "5.2  用户不应将其帐号、密码转让或出借予他人使用。如用户发现其帐号遭他人非法使用，应立即通知库仑。因黑客行为或用户的保管疏忽导致帐号、密码遭他人非法使用的，库仑不承担任何责任。同时，库仑保留在任何时候收回“库仑能网”帐号的权利。\n" +
                "5.3  库仑拥有“库仑能网”的所有权或使用权、以及许可用户使用换电站及电池的权利，并负责换电站及电池的日常投放、保养、维修。同时，“库仑能网”服务系统的所有权及一切知识产权归库仑所有。\n" +
                "5.4  用户在使用“库仑能网”服务过程中，必须遵循以下原则：\n" +
                "遵守中国有关的法律和法规；\n" +
                "遵守所有与本服务有关的网络协议、规定和程序；\n" +
                "不得为任何非法目的而使用本服务系统；\n" +
                "不得以任何形式使用“库仑能网”服务侵犯库仑的商业利益和进行不利于库仑的行为，包括但不限于发布非经库仑许可的商业或非商业广告；\n" +
                "不得利用“库仑能网”服务系统进行任何可能对互联网或移动网正常运转造成不利影响的行为；\n" +
                "不得利用本产品提供的服务展示或传播任何虚假的、骚扰性的、中伤他人的、辱骂性的、恐吓性的、庸俗淫秽的、或者其他任何违反公序良俗或非法的信息资料；\n" +
                ...
                "库仑向用户免费提供的各项服务；\n" +
                "库仑向用户赠送的任何产品或者服务；\n" +
                "库仑向收费网络服务用户附赠的各种产品或者服务；\n" +
                "6.5  “库仑能网”所提供的功能受制于我国的管理条例，即与本产品的功能和条例发生冲突时，应以各地的管理条例为最高准则。任何在使用“库仑能网”服务过程中直接或间接违反当地管理条例的行为，该后果应由用户承担。如有举证需要，库仑可以向有关部门提供相关数据作为证据。\n" +
                "知识产权声明\n" +
                ...
                "8.4  用户理解并确认，库仑需要定期或不定期地对“库仑能网”平台或相关的设备进行检修或者维护，如因此类情况而造成服务在合理时间内的中断，库仑无需为此承担任何责任，但库仑应事先进行通告。\n" +
