...
import com.kulun.energynet.adapter.MyPhotoAdapter;
...
public class QuestionActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bucketName = SharedPreferencesHelper.getInstance(QuestionActivity.this).getString(API.bucketName, "");
    }
    ...
    private void recursiveUploadPhoto(final int account, final int mark) {
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                PutObjectRequest put = new PutObjectRequest(bucketName, objectKey, decodeSampledBitmap(mSelectPath.get(mark), 600, 400));
                list.add(objectKey);
                try {
