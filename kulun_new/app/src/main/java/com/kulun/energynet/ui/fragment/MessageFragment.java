...
import com.kulun.energynet.adapter.MessageInfoAdapter;
import com.kulun.energynet.adapter.MyMessageInfoAdapter;
...
import com.kulun.energynet.ui.activity.WebViewActivity;
...
//                        List<MessageInfo> dataSet = messageInfoList;
                        ...
                        if(loadCount == 0) {
                                    ...
                                    client.post(url, params, new AsyncHttpResponseHandler() {
                                        ...
                                        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                                            ...
                                            if(res != null) {
                                                ...
                                                editor.putString("messageLoadMoreList", res);
                                                editor.commit();
                                                flag = true;
                                            }
                                        }
                            ...
                            if(flag) {
                                SharedPreferences sp =  MainApp.getInstance().getApplicationContext().getSharedPreferences("message",MODE_PRIVATE);
                                String res = sp.getString("messageLoadMoreList", "");
                                Gson gson = new Gson();
