...
import com.botann.driverclient.databinding.LayoutPromotionCountBinding;
import com.botann.driverclient.databinding.LayoutPromotionDetailsBinding;
...
import com.botann.driverclient.ui.basepopup.CountPromotionPopup;
import com.botann.driverclient.ui.basepopup.MonthPopup;
import com.botann.driverclient.ui.basepopup.MonthTypePopup;
import com.botann.driverclient.ui.basepopup.PayPopup;
import com.botann.driverclient.ui.basepopup.PromotionPopup;
...
//                    Utils.toast(PromotionDetailsActivity.this, carinfo.getMsg()+"");
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                Toast.makeText(CountPromotionDetailsActivity.this, "请求失败", Toast.LENGTH_LONG).show();
            }
        });
    }
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(CountPromotionDetailsActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
