...
import com.botann.driverclient.databinding.ActivityChongdianRegisterBinding;
import com.botann.driverclient.databinding.ActivityHuandianRegisterBinding;
 ...
 */
public class ChongdianRegisterActivity extends AppCompatActivity implements View.OnClickListener {
    private ActivityChongdianRegisterBinding binding;
    private TimeCount timeCount;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_chongdian_register);
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_getcode:
                if (!Utils.isFastClick()){
                    Utils.toast(ChongdianRegisterActivity.this, "点击过快");
                    return;
                }
                if (binding.etPhone.getText().toString().isEmpty()){
                    Utils.toast(ChongdianRegisterActivity.this, "请输入手机号");
                    return;
                }
                ...
                if (!canNext){
                    Utils.toast(ChongdianRegisterActivity.this, "手机号格式不正确");
                    return;
                }
                ...
                asyncHttpClient.post(url, requestParams, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        ...
                        Utils.toast(ChongdianRegisterActivity.this, smscodeModel.getMsg()+"");
                    ...
                    public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                        Utils.toast(ChongdianRegisterActivity.this, "连接到服务器失败");
                    }
                });
                break;
            case R.id.tv_login:
                ...
                break;
            case R.id.re:
                Intent intent = new Intent(ChongdianRegisterActivity.this, UseProtocolActivity.class);
    ...
    private void register() {
        ...
        if (binding.etVerification.getText().toString().isEmpty()){
            Utils.toast(ChongdianRegisterActivity.this, "请输入验证码");
            return;
        }
...
//        requestParams.add("type", "0");
        ...
        asyncHttpClient.post(url, requestParams, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if (smscodeModel.isSuccess()){
                    Intent intent = new Intent(ChongdianRegisterActivity.this, SetPasswordActivity.class);
                    intent.putExtra("phone", binding.etPhone.getText().toString());
                    intent.putExtra(API.registertype, "chongdian");
                    startActivity(intent);
                }else {
                    Utils.toast(ChongdianRegisterActivity.this, smscodeModel.getMsg()+"");
                }
