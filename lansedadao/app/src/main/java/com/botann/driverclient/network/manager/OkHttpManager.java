package com.botann.driverclient.network.manager;

import android.os.Handler;
import android.os.Looper;
import android.util.Log;

import com.botann.driverclient.network.callback.BaseCallBack;
...
public class OkHttpManager {
    ...
    //create singleton mode(OkHttp official suggestion)
...
//                            callBack.onSuccess(call, response, object);
    ...
    //create params form which request need
