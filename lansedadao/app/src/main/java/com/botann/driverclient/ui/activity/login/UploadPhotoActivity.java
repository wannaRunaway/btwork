...
import com.botann.driverclient.databinding.ActivityUploadPhotoBinding;
    ...
    private void recursiveUploadPhoto(final int account) {
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                PutObjectRequest put = new PutObjectRequest("electric-app", objectKey, decodeSampledBitmap(pathlist.get(0), 600, 400));
                pathlist.remove(0);
                list.add(objectKey);
                try {
