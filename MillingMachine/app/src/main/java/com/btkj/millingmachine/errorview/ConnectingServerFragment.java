...
import com.btkj.millingmachine.databinding.FragmentConnectingServerBinding;
...
public class ConnectingServerFragment extends Fragment {
    private FragmentConnectingServerBinding binding;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_connecting_server, null);
        binding = FragmentConnectingServerBinding.bind(view);
        hideTimeBack();
        initHeaderBottom();
        return view;
    }
