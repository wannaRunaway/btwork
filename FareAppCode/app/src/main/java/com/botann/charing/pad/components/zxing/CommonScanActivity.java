...
import com.botann.charing.pad.base.QRCodeConstant;
...
//        scanMode=getIntent().getIntExtra(QRCodeConstant.REQUEST_SCAN_MODE, QRCodeConstant.REQUEST_SCAN_MODE_ALL_MODE);
        scanMode=getIntent().getIntExtra(QRCodeConstant.REQUEST_SCAN_MODE, QRCodeConstant.REQUEST_SCAN_MODE_QRCODE_MODE);
        initView();
    }
