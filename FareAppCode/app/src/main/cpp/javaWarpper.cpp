...
Java_com_botann_charing_pad_activity_caridident_PlateRecognition_InitPlateRecognizer(
...
Java_com_botann_charing_pad_activity_caridident_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jobject obj,
