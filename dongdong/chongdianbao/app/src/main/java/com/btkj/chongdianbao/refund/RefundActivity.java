...
import com.btkj.chongdianbao.adapter.GridViewAdapter;
import com.btkj.chongdianbao.databinding.ActivityRefundBinding;
...
import com.btkj.chongdianbao.model.OssTokenModel;
...
import com.btkj.chongdianbao.utils.CompressUtils;
...
//                    String endpoint = "https://oss-cn-hangzhou.aliyuncs.com";
                    ...
                    if (!TextUtils.isEmpty(ossTokenModel.getMsg())&&isCommit) {
                        Utils.snackbar(getApplicationContext(), RefundActivity.this, ossTokenModel.getMsg());
                    }
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                if(isCommit){
                    Utils.snackbar(getApplicationContext(), RefundActivity.this, API.net_error);
                }
           }
        });
    }
    private void cleanLoginInfo(){
        ...
        Utils.snackbar(getApplicationContext(),RefundActivity.this,"请重新登录");
        ...
        binding.ivCommit.setOnClickListener(new OnClickEvent(500) {
            ...
            public void singleClick(View v) {
                ...
                if(TextUtils.isEmpty(balance)){
                    Utils.snackbar(getApplicationContext(),RefundActivity.this,"请输入退款金额");
                    return;
                }
                if(Double.valueOf(balance)>realAmount){
                    Utils.snackbar(getApplicationContext(),RefundActivity.this,"退款金额不能大于实际支付金额");
                    return;
                }
                if(TextUtils.isEmpty(reason)){
                    Utils.snackbar(getApplicationContext(),RefundActivity.this,"请输入退款原因");
                    return;
                }
                commit();
            }
                ...
                oss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
                    ...
                    public void onFailure(PutObjectRequest request, ClientException clientExcepion, ServiceException serviceException) {
                        ...
                        runOnUiThread(() -> {
                            ...
                            Utils.snackbar(getApplicationContext(), RefundActivity.this, "图片上传失败");
                        });
                    }
                });
            }
