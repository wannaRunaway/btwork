...
import com.btkj.chongdianbao.databinding.ActivityRechargeBinding;
import com.btkj.chongdianbao.main.BaseActivity;
import com.btkj.chongdianbao.model.AuthResult;
import com.btkj.chongdianbao.model.BaseObject;
import com.btkj.chongdianbao.model.PayResult;
import com.btkj.chongdianbao.model.User;
import com.btkj.chongdianbao.model.WxPayModel;
import com.btkj.chongdianbao.utils.API;
import com.btkj.chongdianbao.utils.CashInputFilter;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.recharge:
                ...
                if (money.isEmpty()) {
                    Utils.snackbar(getApplicationContext(), RechargeActivity.this, "请选择或者填写支付金额");
                    return;
                }
                if (rechargeType == 0) {
                    Utils.snackbar(getApplicationContext(), RechargeActivity.this, "请选择微信或者支付宝支付");
                    return;
                }
                recharge(money);
                break;
    ...
    private void recharge(String money) {
        try {
            if (Double.parseDouble(money) < 1.00&& !Constants.isDebug ) {
                Utils.snackbar(getApplicationContext(), RechargeActivity.this, "充值金额最少为1元");
                return;
            }
        }catch (Exception e){
            ...
            public void message(String json) {
                if (rechargeType == 2) {
                    ...
                    if (model.isSuccess()) {
                        ...
                        Utils.snackbar(getApplicationContext(), RechargeActivity.this, model.getMsg());
                    }
                    ...
                    if (baseObject.isSuccess()) {
                        ...
                        Utils.snackbar(getApplicationContext(), RechargeActivity.this, baseObject.getMsg());
                    }
                }
            }
        });
...
//                Utils.snackbar(getApplicationContext(), RechargeActivity.this, API.net_error);
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Utils.snackbar(getApplicationContext(), RechargeActivity.this, "支付成功");
...
//                        finish();
                        ...
                        Utils.snackbar(getApplicationContext(), RechargeActivity.this, "支付失败");
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000") && TextUtils.equals(authResult.getResultCode(), "200")) {
                        ...
                        // 传入，则支付账户为该授权账户
                        Utils.snackbar(getApplicationContext(), RechargeActivity.this,
